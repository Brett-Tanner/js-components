...
const addBubbleMenus = () => {
  ...
  const bottomRight = bubble(
    [{ action: "", classes: [""], imageSrc: "", text: "" }],
    {
...
// Remember to use dvh for the positioning of the bubble
